    ...
    //                                                        side: THREE.DoubleSide }
      ...
      const materialTexture= [];
            materialTexture.push(new THREE.MeshStandardMaterial({ color: 0xffffff,
                map: new THREE.TextureLoader().load('../img/face1.png'), }));

            materialTexture.push(new THREE.MeshStandardMaterial({ color: 0xffffff,
                map: new THREE.TextureLoader().load('../img/face2.png')}));

            materialTexture.push(new THREE.MeshStandardMaterial({ color: 0xffffff,
                map: new THREE.TextureLoader().load('../img/face3.png')}));

            materialTexture.push(new THREE.MeshStandardMaterial({ color: 0xffffff,
                map: new THREE.TextureLoader().load('../img/face4.png')}));

                
            materialTexture.push(new THREE.MeshStandardMaterial({ color: 0xffffff,
                map: new THREE.TextureLoader().load('../img/face5.png')}));
                
            materialTexture.push(new THREE.MeshStandardMaterial({ color: 0xffffff,
                map: new THREE.TextureLoader().load('../img/face6.png')}));
